...
document.querySelector(".planilha-btn").addEventListener("click", function () {
  ...
  fetch("http://localhost:8080/usuarios/fidelizados")  // Altere para a sua URL que retorna todos os dados de clientes
    ...
    .then(data => {
      ...
      exportTableToExcel("procedures-table", "ClientesFidelizados.xlsx");
    })
    .catch(error => {
